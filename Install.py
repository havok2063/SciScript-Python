...
def isSciServerComputeEnvironment():
    ...
    Returns True if the library is being run within the SciServer-Compute environment, and False if not.
    """
    return os.path.isfile("/home/idies/keystone.token")
...
# activating python = python2 in anaconda, and then changing back to the anaconda default of python = python3
if isSciServerComputeEnvironment():
    os.system("source activate py27 ; python setup.py install ; source activate root")
else:
